...
export default function WorkoutUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...workoutRecord };
    setWarm_up(cleanValues.warm_up);
    setCool_down(cleanValues.cool_down);
    setMuscle_group(cleanValues.muscle_group);
    setErrors({});
  };
  const [workoutRecord, setWorkoutRecord] = React.useState(workout);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Workout, id) : workout;
